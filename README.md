# Md. Sajjad Hossain - Avionics Portfolio
...
![Avionics portfolio social preview](./public/og-image.png)

An interactive mission-control portfolio for **Md. Sajjad Hossain**, an avionics engineering student working across embedded systems, rocket avionics, radar research, flight interfaces and software development.

## Mission brief

The site turns a traditional engineering CV into an interactive technical narrative. It combines a responsive aerospace HUD visual system with project dossiers, engineering experience, public software repositories and a privacy-safe downloadable CV.
...
- Code-native visual previews for public software projects
...
| Skills and public project links | `src/App.jsx` |
